...
/* Add signup form to Subscribe nav menu item. */

/* Signup form */
function lawyerist_nav_menu_signup_form() {
...
/* Search form */
function lawyerist_nav_menu_search_form() {

	<form role="search" method="get" class="search-form" action="<?php echo home_url( '/' ); ?>">
		<label>
			<span hidden class="screen-reader-text"><?php echo _x( 'Search Lawyerist.com: ', 'label' ) ?></span>
			<input type="search" class="search-field" name="s" placeholder="<?php echo esc_attr_x( 'Search Lawyerist.com …', 'placeholder' ) ?>" title="<?php echo esc_attr_x( 'Search Lawyerist.com', 'label' ) ?>" />
		</label>
