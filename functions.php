...
/* This loads our fonts and styles */
...
function xyz_amp_my_additional_css_styles( $amp_template ) {
    ?>
		...
		@font-face {
		    font-family: 'adler';
		    src: url('<?php echo get_template_directory_uri(); ?>/fonts/adler/adler-webfont.woff') format('woff');
		    font-weight: normal;
		    font-style: normal;
		}
		...
		@font-face {
		    ...
		    src: url('<?php echo get_template_directory_uri(); ?>/fonts/concourse/concourse_t6_regular-webfont.woff') format('woff');
		    font-weight: bold;
		    font-style: normal;
		}
		...
		@font-face {
		    font-family: 'concourse-headings';
		    src: url('<?php echo get_template_directory_uri(); ?>/fonts/concourse/concourse_t6_italic-webfont.woff') format('woff');
		    font-weight: bold;
		    font-style: italic;
		}
		...
		@font-face {
		    ...
		    src: url('<?php echo get_template_directory_uri(); ?>/fonts/concourse/concourse_t4_regular-webfont.woff') format('woff');
		    font-weight: normal;
		    font-style: normal;
		}
		...
		@font-face {
		    font-family: 'concourse';
		    src: url('<?php echo get_template_directory_uri(); ?>/fonts/concourse/concourse_t4_italic-webfont.woff') format('woff');
		    font-weight: normal;
		    font-style: italic;
		}
		...
		@font-face {
		    font-family: 'concourse';
		    src: url('<?php echo get_template_directory_uri(); ?>/fonts/concourse/concourse_t4_bold-webfont.woff') format('woff');
		    font-weight: bold;
		    font-style: normal;
		}
		...
		@font-face {
		    font-family: 'concourse';
		    src: url('<?php echo get_template_directory_uri(); ?>/fonts/concourse/concourse_t4_bold_italic-webfont.woff') format('woff');
		    font-weight: bold;
		    font-style: italic;
		}
		...
		@font-face {
		    font-family: 'equity';
		    src: url('<?php echo get_template_directory_uri(); ?>/fonts/equity/equity_text_b_regular-webfont.woff') format('woff');
		    font-weight: normal;
		    font-style: normal;
		}
		...
		@font-face {
		    font-family: 'equity';
		    src: url('<?php echo get_template_directory_uri(); ?>/fonts/equity/equity_text_b_italic-webfont.woff') format('woff');
		    font-weight: normal;
		    font-style: italic;
		}
		...
		@font-face {
		    font-family: 'equity';
		    src: url('<?php echo get_template_directory_uri(); ?>/fonts/equity/equity_text_b_bold-webfont.woff') format('woff');
		    font-weight: bold;
		    font-style: normal;
		}
		...
		@font-face {
		    font-family: 'equity';
		    src: url('<?php echo get_template_directory_uri(); ?>/fonts/equity/equity_text_b_bold_italic-webfont.woff') format('woff');
		    font-weight: bold;
		    font-style: italic;
		}
		...
		@font-face {
		    ...
		    src: url('<?php echo get_template_directory_uri(); ?>/fonts/triplicate/triplicate_t4_code_regular-webfont.woff') format('woff');
		    font-weight: normal;
		    font-style: normal;
		}
