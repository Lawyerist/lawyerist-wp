    ...
    // Outputs the Scorecard call to action.
		echo '<div id="big_hero" class="index_post_container">';
			echo '<a id="big_hero_top" href="https://lawyerist.com/scorecard/">';
				echo '<div id="scorecard_image_wrapper"><img src="https://lawyerist.com/lawyerist/wp-content/uploads/2018/02/scorecard.png" alt="The Small Firm Scorecard example" /></div>';
